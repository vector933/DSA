...
int main()
{
    ...
    Ayush.level = 'A';
    //use getter
    cout<< "Health of Ayush is: "<< Ayush.gethealth() << endl;
    cout<< "Level of Ayush is: "<< Ayush.level << endl;

    Hero *S = new Hero();
    delete S;   // we have to call destructor manually by deleting dynamically created object this fxn
